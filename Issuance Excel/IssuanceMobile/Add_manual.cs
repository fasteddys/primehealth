        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {//insert is her
                    ...
                    SqlCommand sqlcmd = new SqlCommand("insert into Loginer values ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + null + "','" + comboBox1.Text + "','" + comboBox2.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','Activated')", sqlcon);
                    sqlcon.Open();
