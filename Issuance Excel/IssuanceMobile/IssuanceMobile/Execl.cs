...
namespace IssuanceMobile
{
    public partial class Execl : Form
    {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
         ...
         // SqlConnection sqlconnection = new SqlConnection(@"Data Source=MOHAMED_ABDELAL;Initial Catalog=PhNetwork;Integrated Security=True");
           SqlConnection sqlconnection = new SqlConnection(@"Data Source=10.1.1.39;Initial Catalog=PhNetwork;Integrated Security=False;User Id=sa;Password=P@ssw0rd;");
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        newRow.Rows.Add(DataGridExcelSheet.Rows[i].Cells[0].Value.ToString()
                            ...
                            DataGridExcelSheet.Rows[i].Cells[3].Value.ToString(),
            ...
            try
            {
                ...
                using (SqlBulkCopy bulkCopy = new SqlBulkCopy(sqlconnection))
                {
                    SqlCommand Getcount_before_insert =new SqlCommand("select COUNT (Medical_id) From Loginer ", sqlconnection);
                     count_before = (int)Getcount_before_insert.ExecuteScalar();
                    ...
                    SqlCommand Getcount_after_insert = new SqlCommand("select COUNT (Medical_id) From Loginer ", sqlconnection);
                     count_after = (int)Getcount_after_insert.ExecuteScalar();
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                CountaAllData.Text = "No Data has inserted";
                CountaAllData.Visible = true;
            }
            ...
            else
            {
               ...
               // pro.ShowDialog();
                ...
                CountaAllData.Visible = true;
                CountaAllData.Text ="number of Added rows is  "+ (count_after - count_before).ToString();
                //pro.Close();
            }
            button1.Enabled = false;
        }
