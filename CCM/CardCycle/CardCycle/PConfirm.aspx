<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/Site2.Master"  AutoEventWireup="true" CodeBehind="PConfirm.aspx.cs" Inherits="CardCycle.PConfirm" %>
                                            ...
                                            <asp:ListView runat="server" ID="lstNewReq">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td><span class="label label-warning" style="background: #0ea3dc"><%#Eval("States") %> </span></td>
