<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/Site2.Master"  AutoEventWireup="true" CodeBehind="RequestNew.aspx.cs" Inherits="CardCycle.RequestNew" %>
				     		...
				     		<table data-sortable class="table">
										...
										<tbody>
                                            <asp:ListView runat="server" ID="lstNewReq">
                                                ...
                                                <td><%#Eval("rdate") %></td>
                                                <td><span class="label label-success"> <%#Eval("States") %> </span></td>
