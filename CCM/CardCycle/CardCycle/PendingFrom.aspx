<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/Site2.Master"  AutoEventWireup="true" CodeBehind="PendingFrom.aspx.cs" Inherits="CardCycle.PendingFrom" %>
				     		...
				     		<table data-sortable class="table">
										...
										<tbody>
                                            <asp:ListView runat="server" ID="lstNewReq">
                                                ...
                                                <td><%#Eval("ApvUnderWriting") %></td>
                                                <td><%#Eval("apvIssuance") %></td>
                                                 <td><%#Eval("AssignPrint") %></td>
