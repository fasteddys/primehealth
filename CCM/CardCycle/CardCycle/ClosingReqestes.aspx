<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/Site2.Master"  AutoEventWireup="true" CodeBehind="ClosingReqestes.aspx.cs" Inherits="CardCycle.ClosingReqestes" %>
				     		...
				     		<table data-sortable class="table">
										...
										<tbody>
                                            <asp:ListView runat="server" ID="lstNewReq">
                                                ...
                                                <td><span class="label label-info"> <%#Eval("States") %> </span></td>
