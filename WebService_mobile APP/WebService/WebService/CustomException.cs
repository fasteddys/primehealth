...
namespace WebService.Utilities
{
    ...
    public static class ExceptionHandlerConstants
    {
        ...
        public static void CreateException(Exception e, string methodname)
        {
            ...
            var connectionstring = ConfigurationManager.AppSettings["PhNetworkConnectionString"].ToString();

            using (SqlConnection con = new SqlConnection(connectionstring))
            {
                string query = "INSERT INTO [dbo].[PhLog] (LogDetails, LogType,ClassName,MethodName) VALUES (@LogDetails, @LogType,@ClassName,@MethodName) ";
        ...
        public static void CreateException(Exception e, string className, string methodname)
        {
