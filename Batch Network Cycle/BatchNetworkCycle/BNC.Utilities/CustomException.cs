...
namespace BNC.Utilities
{
    ...
    public static class ExceptionHandlerConstants
    {
        ...
        public static void CreatBNCException(Exception e, string className, string methodname, string ErrorSource)
        {
            CustomException ex = CreateCustomException(className, methodname, e);
            var connectionstring = ConfigurationManager.AppSettings["BNCConnectionString"].ToString();
