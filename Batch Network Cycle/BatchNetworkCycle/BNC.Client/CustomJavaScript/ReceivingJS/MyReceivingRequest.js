...
function GetReceivingRequest() {
    var URLReceivingRequest = "/Receiving/MyReceivingRequests?RecevingOfficerID=" + Common.GetUserData().UserID;
    Common.Ajax("get", URLReceivingRequest, null, 'json', sucessGetReceivingRequest);
}
