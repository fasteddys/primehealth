...
function GetStatusForEntity() {
    var urlGetStatusForEntity = '/Entities/GetStatusOfEntity?EntityID=' + Common.Entites.ReceivingRequest;
...
function GetReceivingRequest() {
    var Search = {
        FieldsNames: 'ReceivingRequestID,BilllingMonth,BillingYear,ReceivedClaimsCount,ProviderFK,ReceivingDate',
    ...
    Common.Ajax("Post", URLReceivingRequest, JSON.stringify(Search), 'json', sucessGetReceivingRequest);
}
