$(document).ready(function () {
    var urlgetAllPendingBatchingRequests = "/Batching/getAllPendingBatchingRequestsAtFilitrationBatchingData";
    Common.Ajax("get", urlgetAllPendingBatchingRequests, null, 'json', sucessgetAllPendingBatchingRequests);
});
/*-----------------------------------------------------------*/
function sucessgetAllPendingBatchingRequests(Result) {
    if (Result.Success) {
