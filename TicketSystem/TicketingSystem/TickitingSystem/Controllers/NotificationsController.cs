...
namespace TickitingSystem.Controllers
{
    ...
    public class NotificationsController : Controller
    {
        ...
        public PartialViewResult PushPartial(string ID)
        {
                    Permission_DAL permission = new Permission_DAL();
            int IDS = Convert.ToInt16(ID);

            if (permission.CheckIfUserHasPermission("Notifications-Push"))
            {
                User_DAL userDAL = new User_DAL();
                TicketDAL ticketDAL = new TicketDAL();
                TicketDetail ticketdetailsDAL = new TicketDetail();
                User theloginuser = userDAL.GetUserById(IDS);
        ...
        public PartialViewResult GetmessagesPartial(int ID)
        {
            User_DAL userDAL = new User_DAL();
            TicketDAL ticketDAL = new TicketDAL();
            TicketDetail ticketdetailsDAL = new TicketDetail();
