...
function getmytickets()
{
    ...
    $.ajax({
        url: 'http://localhost:55341/Dashboard/countNumberOfNewTicket',
        type: 'Get',
        data: { 'UserID': User_ID },
...
function closedticket() {
    ...
    var User_ID = getCookie("UserIDCookie");
    $.ajax({
        url: 'http://localhost:55341/Dashboard/countNumberOfClosedJson',
        type: 'Get',
        data: { 'UserID': User_ID },
        contentType: 'application/json',
...
function countNumberOfpendin() {
    ...
    var User_ID = getCookie("UserIDCookie");
    $.ajax({
        url: 'http://localhost:55341/Dashboard/countNumberOfpendingForConfirmation',
        type: 'Get',
        data: { 'UserID': User_ID },
        contentType: 'application/json',
...
function PendingforReviewticket() {
    ...
    var User_ID = getCookie("UserIDCookie");
    $.ajax({
        url: 'http://localhost:55341/Dashboard/countNumberOfPendingforReview',
        type: 'Get',
        data: { 'UserID': User_ID },
        contentType: 'application/json',
...
function getTheBestEmplyee() {
    ...
    var User_ID = getCookie("UserIDCookie");
    $.ajax({
        url: 'http://localhost:55341/Dashboard/TheBestEmplyee',
        type: 'Get',
        contentType: 'application/json',
...
function getThemostaskEmplyee() {
    ...
    var User_ID = getCookie("UserIDCookie");
    $.ajax({
        url: 'http://localhost:55341/Dashboard/ThemostaskEmplyee',
        type: 'Get',
        contentType: 'application/json',
...
function PendingforReviewDataquest() {
    ...
    var User_ID = getCookie("UserIDCookie");
    $.ajax({
        url: 'http://localhost:55341/Dashboard/countNumberOfPendingforReviewDataquest',
        type: 'Get',
        data: { 'UserID': User_ID },
        contentType: 'application/json',
...
function PendingforReviewITfusion() {
    ...
    var User_ID = getCookie("UserIDCookie");
    $.ajax({
        url: 'http://localhost:55341/Dashboard/countNumberOfPendingforReviewITfusion',
        type: 'Get',
        data: { 'UserID': User_ID },
        contentType: 'application/json',
