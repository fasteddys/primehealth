    ...
    public class Mailing
    {
...

        {
            ...
            message.Body = "Dear IT Team" + "  , " + "\t\r" + user.User_Name + " has just Opened a New Ticket  " +
              "To View ticket Login and Visit http://10.1.1.25:9292/Ticket/ManageTicket?id=" + ticketid;
...

        {
            ...
            message.Body = "Dear " + user.User_Name + "  , " + "\t\r" + "Kindly informed that we opened a new ticket  with " + ticktname + ", Request ID :" + outsourceid + "\t\r" +
                "To View ticket Login and Visit http://10.1.1.25:9292/Ticket/ManageTicket?id=" + ticketid;
            message.From = "Ticket.System@Prime-Health.org";
