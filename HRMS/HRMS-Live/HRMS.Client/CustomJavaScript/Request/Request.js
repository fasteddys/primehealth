...
var AddNewRequest = function () {
    ...
    if ($('option:selected', $("#LeaveType")).attr('Unit') === "Days") {
        ...
        var z = timeToSeconds(ConvertFromShotTimeToongTime($("#TimeFrom")[0].value));
        var m = timeToSeconds('8:30:00');
        var t = timeToSeconds('17:00:00');
        if (z < m || z > t) {

            IsValid = false;
            Message = Message + "Time Must Be Between 8:30 and 5:00";
        }
