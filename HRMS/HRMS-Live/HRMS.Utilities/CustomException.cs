...
namespace HRMS.Utilities
{
    ...
    public static class ExceptionHandlerConstants
    {
        ...
        public static void CreateCypressException(Exception e, string className, string methodname,string ErrorSource)
        {
            CustomException ex = CreateCustomException(className, methodname, e);
            var connectionstring = ConfigurationManager.AppSettings["cypressConnectionString"].ToString();
