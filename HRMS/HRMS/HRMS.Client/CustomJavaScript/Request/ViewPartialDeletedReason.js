        ...
        var NewSearchForUserDeleted =
            {
                ...
                RequestStatus: 5//request stauts partial deleted
            }

        var urlGetDeletedReasonForUserByID = ConfigurationData.GlobalApiURL + "/Request/GetAllPartialDeletedReason";//will be change
...
$('#ExtractDeletedReason').click(function () {
    ...
    else
    {
        var NewSearch = {
            ...
            RequestTo: DateTo,
            RequestLeaveTypeID: LeaveTypeID,
            RequestStatus: 4,//partial deleted
        };
        var urlGetDeletedReasonForUserByIDExcel = ConfigurationData.GlobalApiURL + "/Request/GetAllPartialDeletedReasonExcel";
        ...
        xhttp.onreadystatechange = function () {
            ...
            if (xhttp.readyState === 4 && xhttp.status === 200) {
                ...
                a.download = "CypressPartialDeletedReasonReport" + date + ".xls";
...
{
    var getAllDeletedReasonsForSpecificRequest = ConfigurationData.GlobalApiURL + "/Request/getAllPartialDeletedReasonsForSpecificRequestById?reqId=" + reqId;//will be change
