...
$(document).ready(function () {
    ...
    var WorkingModeID = $('#WorkingMode :selected').val();
    if (WorkingModeID === '1') {
        $('#WWeek').show();
    }
...
function RenderDropdownData(DropdownsData) {
    ...
    var workingModeOption = '<option value="null">None</option>';
    $("#WorkingMode").append(workingModeOption);
    for (var n = 0; n < DropdownsData.Data.WorkingMode.length; n++) {
        workingModeOption = '<option value="' + DropdownsData.Data.WorkingMode[n].WorkingModeID + '">' + DropdownsData.Data.WorkingMode[n].WorkingModeName + '</option>';
        $("#WorkingMode ").append(workingModeOption);
    }

    var workingWeekOption = '<option value="null">None</option>';
    $("#WorkingWeek").append(workingWeekOption);
    for (var n = 0; n < DropdownsData.Data.WorkingWeek.length; n++) {
        workingWeekOption = '<option value="' + DropdownsData.Data.WorkingWeek[n].WorkingWeekID + '">' + DropdownsData.Data.WorkingWeek[n].WorkingWeekName + '</option>';
        $("#WorkingWeek ").append(workingWeekOption);
    }
...
function RenderUserData(EmployeeData) {
    ...
    EmployeeData.Data.WorkingModeID !== null ? $("#WorkingMode").val(EmployeeData.Data.WorkingModeID) : null;
    EmployeeData.Data.WorkingWeekID !== null ? $("#WorkingWeek").val(EmployeeData.Data.WorkingWeekID) : null;
...
function GetUpdatedUserData() {
    var UserData = {
        ...
        WorkingModeID: $("#WorkingMode").val(),
        WorkingWeekID: $("#WorkingWeek").val(),
