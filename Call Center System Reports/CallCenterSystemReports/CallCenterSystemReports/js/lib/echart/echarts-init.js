$(document).ready(function () {
   ...
   // <!--Negative Bar echarts init-- >
    ...
    $.ajax({
      ...
      //  url: "/CallCenterReportingSystem/Home/TicketscountGroupedbyWarnningTypeForOperators",
        url: "/Home/TicketscountGroupedbyWarnningTypeForOperators",
        type: "Get",
        ...
        success: function (Totaldata) {
            ...
            for (var i = 0; i < Totaldata.length; i++) {
                CountOp[i] = Totaldata[i].TicketsCount;
            }
        ...
        series: [
            {
                ...
                center: ['50%', '60%'],
                data: [
                    { value: CountOp[0], name: 'Normal' },
                    { value: CountOp[1], name: 'Delayed' }
                ]
            }
        ]
    };
    ...
    $.ajax({
       ...
       // url: "/CallCenterReportingSystem/Home/TicketscountGroupedbyWarnningType",
        url: "/Home/TicketscountGroupedbyWarnningType",
        type: "Get",
        contentType: "application/json;charset=utf-8",
        async: false,
        success: function (Totaldata) {
            ...
            for (var i = 0; i < Totaldata.length; i++) {
                Count[i] = Totaldata[i].TicketsCount;
            }
    ...
    option = {
        ...
        color: ['#4aa9e9', '#eac459', '#ff6c60', '#D8313A'],
        tooltip: {
            trigger: 'item',
            formatter: '{a} <br/>{b} : {c} ({d}%)'
        },
        ...
        //    orient: 'horizontal',
        //    x: 'left',
        //    data: ['Normal', 'First Warning', 'Second Warning', 'Third Warning']
        //},
        calculable: true,
        series: [
            {
                ...
                radius: ['50%', '70%'],
                data: [
                    { value: Count[0], name: 'Normal' },
                    { value: Count[1], name: 'First Warning' },
                    { value: Count[2], name: 'Second Warning' },
                    { value: Count[3], name: 'Third Warning' }
                ]
            }
        ]
    };
