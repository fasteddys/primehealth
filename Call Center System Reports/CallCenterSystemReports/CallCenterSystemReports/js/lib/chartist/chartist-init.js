...
SelectedDate = $("#RateDatePicker").val();

        $.ajax({
          //  url: "/CallCenterReportingSystem/Home/RequestCountOverDay",
            url: "/Home/RequestCountOverDay",
            ...
            success: function (Hdata) {
                ...
                for (var i = 0; i < Hdata.length; i++) {
                    HoursCount[i] = Hdata[i].RequestCount;
...
var chart = new Chartist.Line('.ct-animation-chart', {
  ...
  series: [HoursCount]
      //[4, 5, 3, 7, 3, 5, 5],
      //[5, 3, 4, 5, 6, 3, 3, 4, 5, 6, 3, 4, 3, 4, 5, 3, 7, 3, 5, 5, 3, 4, 4, 5],
      //[8, 18, 7, 7, 2, 9, 4, 7,2, 1, 0, 7, 2, 5, 7, 0, 3, 4, 9, 12, 0, 4, 4, 5]
