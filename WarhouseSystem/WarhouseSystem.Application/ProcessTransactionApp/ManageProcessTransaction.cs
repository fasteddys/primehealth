...
namespace WarhouseSystem.Application.ProcessTransactionApp
{
    public class ManageProcessTransaction : IManageProcessTransaction
    {
        ...
        public IEnumerable<ProcessTransactionViewModel> GetAllProcessTransactions()
        {
            IEnumerable<ProcessTransaction> AllProcessTransactions = unit.processTransactionRepository.GetAllData();
