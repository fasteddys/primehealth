...
namespace WarhouseSystem.EF.UnitOfWork
{
    public  class UnitOfWork : IDisposable
    {
        ...
        private ItemAttachmentRepository _itemAttachmentRepository;
        ...
        public ItemAttachmentRepository itemAttachmentRepository
        {
            get
            {
                lock (lockPad)
                {
                    if (this._itemAttachmentRepository == null)
                        this._itemAttachmentRepository = new ItemAttachmentRepository(_dbContext);
                }
                return this._itemAttachmentRepository;
            }
        }
