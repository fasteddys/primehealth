<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="QualityClosed.aspx.cs" Inherits="WebApplication1.Portal.QualityClosed" %>
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Quality Closed Requests</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <table class="table table-hover demo-table-search" id="tableWithSearch" >
                    <thead>
                        <tr>
                            ...
                            <td>Request Date</td>
                            <td>Assign Date</td>
                            <td>Finished Searching</td>
                            <td>Finished Quality</td>
                            <td>Assigned To</td>
                            <td>Quality By</td>
                            <td>Status</td>
                            <td>Total Claims</td>
