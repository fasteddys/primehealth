<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" enableEventValidation="true" AutoEventWireup="true" CodeBehind="ClosedArchTick.aspx.cs" Inherits="WebApplication1.Portal.ClosedArchTick" %>
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Quality Control</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <asp:ListView runat="server" ID="ItemsList">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><b><%#Eval("ClosedPerson") %></b></td>
                                    <td><b><%#Eval("ClosedDate") %></b></td>
                                    <td><b><%#Eval("Reciver") %></b></td>
                                    <td><b><%#Eval("ReciveDate") %></b></td>
