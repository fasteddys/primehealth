            ...
            <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
                ...
                <div class="login-box clearfix animated flipInY">
                    <div class="login-logo">
                        <a href="#">
                            <img src="LoginAssets/img/login-logo.png" alt="Company Logo" /></a>
                    </div>
                    <hr />
...
<%--    <footer class="container">
        <p id="footer-text"><small>Copyright &copy; <%: DateTime.Now.Year %> <a href="#">PrimeHealth | Developed By | Abdallah Yehia</a></small></p>
    </footer>--%>
