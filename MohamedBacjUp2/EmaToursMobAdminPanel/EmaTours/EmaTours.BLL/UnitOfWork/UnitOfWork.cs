...
namespace EmaTours.BLL.UnitOfWork
{
    public class UnitOfWork
    {
        ...
        private TripCurrencyBLL tripCurrencyBLL;
        public TripCurrencyBLL TripCurrencyBLL
        {
            get
            {

                if (this.tripCurrencyBLL == null)
                {
                    this.tripCurrencyBLL = new TripCurrencyBLL(Context, CreationDate);
                }
                return tripCurrencyBLL;
            }
        }
