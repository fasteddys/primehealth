$(document).ready(function () {      
    ...
    function init_template(){//Class is vital to run AJAX Pages 
        ...
        $('.open-header-menu, .close-header-menu').click(function(){
            $('.header-menu-overlay').addClass('active-tap-close');
            $('.open-header-menu').find('i').toggleClass('rotate-180 color-red-light');
            $('.header-menu').toggleClass('header-menu-active'); 
            return false;
        });
        $('.header-menu a').click(function(){
            $(this).find('i').toggleClass('rotate-180 color-red-light');
            $('.header-menu').removeClass('header-menu-active'); 
        });    
        $('.close-header-menu, .header-menu-overlay').click(function(){
            $('.header-menu-overlay').removeClass('active-tap-close');
            $('.open-header-menu').find('i').removeClass('rotate-180 color-red-light');
            $('.header-menu').removeClass('header-menu-active'); 
            return false;
        });
        ...
        //    $('.open-modal-menu').find('i').toggleClass('rotate-45 color-red-light');
        //    return false;
        //});
        ...
        $('.open-left-sidebar').click(function(){
            $('.material-menu').addClass('opacity-out');
            $('.open-header-menu').find('i').removeClass('rotate-180 color-red-light');
            $('.header-menu').removeClass('header-menu-active'); 
        ...
        //Checking Submenu Status and Disabling Clicks to Main Sidebar
        if($('body').find('.active-submenu').length === 1){
            $('body').find('.sidebar-scroll').addClass('stop-scroll');
            $('body').find('.sidebar-scroll a').addClass('no-pointer-events');
            $('body').find('.active-submenu a').addClass('all-pointer-events'); 
        } else {
            $('body').find('.sidebar-scroll').removeClass('stop-scroll');
            $('body').find('.sidebar-scroll a').removeClass('no-pointer-events');
            $('body').find('.active-submenu a').removeClass('all-pointer-events'); 
        }
        ...
        $('.open-submenu').click(function(){           
            ...
            $('.sidebar-scroll a').addClass('no-pointer-events');
            $('.active-submenu a').addClass('all-pointer-events');
            return false;
        });    
        ...
        $('.close-submenu').click(function(){   
            ...
            $('.sidebar-scroll a').removeClass('no-pointer-events');
            $('.active-submenu a').removeClass('all-pointer-events');
            return false;
        });     
        ...
        var swiper_store_thumbnail_slider1 = new Swiper('.home-round-slider', {
            pagination: '.swiper-pagination',
            paginationClickable: true,
            slidesPerView: 3,
            spaceBetween: 20,
        ...
        var swiper1 = new Swiper('.home-slider',{autoplay:4000, loop:true});
