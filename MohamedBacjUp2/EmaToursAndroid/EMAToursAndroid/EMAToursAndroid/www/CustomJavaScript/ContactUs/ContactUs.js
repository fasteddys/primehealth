$(document).ready(function () {
    ...
    var urlContactus = GlobalResourses.BaseURL + "Configuration/GetConfigurationValue?ConfigurationKey=" + "ContactUsData" + "&LanguageId=" + localStorage.getItem("LanguageID");
    Common.Ajax('get', urlContactus, null, 'json', SucessurlGetConfigurationValue, false);
...
function SucessurlGetConfigurationValue(Result) {
    $("#EmaToursContacts").append(Result.Data);
}
