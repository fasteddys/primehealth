...
namespace OnlineApprovals.Utilities
{
    ...
    public static class ExceptionHandlerConstants
    {
        ...
        public static void CreateException(Exception e, string methodname)
        {
            ...
            {
                string query = "INSERT INTO [dbo].[OnlineApprovals.FailedTransactions] (LogDetails, LogType,ClassName,MethodName) VALUES (@LogDetails, @LogType,@ClassName,@MethodName) ";
