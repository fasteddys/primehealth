using CypressPendingRequestsReminderApp.DTOs;
using CypressPendingRequestsReminderApp.Entities;
using CypressPendingRequestsReminderApp.StaticData;
using System;
...
using static CypressPendingRequestsReminderApp.StaticData.StaticEnums;

namespace CypressPendingRequestsReminderApp.BLL
{
    class RequestBLL
    {
        ...
        //    {
        //        foreach (var item in HRMS.Configurations.Where(x => x.ConfigurationKey == "EmailReminderTime").Select(x => x.ConfigurationValue).ToList())
        //        {
