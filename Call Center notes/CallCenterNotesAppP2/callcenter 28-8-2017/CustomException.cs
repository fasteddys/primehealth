...
namespace CallCenterNotesApp.CustomExceptions
{
    ...
    public static class ExceptionHandlerConstants
    {
        ...
        public static void CreateException(Exception e, string methodname, string ErrorSource)
        {
            CustomException ex = CreateCustomException("ReportAgent", methodname, e);
            var connectionstring = ConfigurationSettings.AppSettings["PhNetworkConnectionString"].ToString();

            using (SqlConnection con = new SqlConnection(connectionstring))
            {
                string query = "INSERT INTO [dbo].[EmailApprovalsFailedTransactions] (LogDetails, LogType,ClassName,MethodName,LogDate,ErrorSource) VALUES (@LogDetails, @LogType,@ClassName,@MethodName,@LogDate,@ErrorSource)";
        ...
        public static void CreateException(Exception e, string className, string methodname,string ErrorSource)
        {
