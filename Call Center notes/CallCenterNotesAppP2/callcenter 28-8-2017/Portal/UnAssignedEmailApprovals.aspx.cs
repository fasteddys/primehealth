...
{
    public partial class UnAssignedEmailApprovals : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("UnAssignedEmailApprovals")).Attributes["class"] = "active";
            if (!IsPostBack)
            {
        ...
        public void Bind(string Type, string SubType, int? asc)
        {
            try
            {
                ...
                var data = helper.GetUnAssignedRequestsByUserName(user, Type, SubType, asc).Take(20).ToList();
                ...
                int NumberOfPages = pageing.PageNumbers(20, helper.GetUnAssignedRequestsByUserNameCount(user));
        ...
        private void ButtonChange_Click(object sender, EventArgs e)
        {
            ...
            ChangePage(btn.Text, DropDownType.SelectedValue, Convert.ToInt16(DropDownAsc.SelectedValue));
            ViewState["currentpage"] = btn.Text;

        }
        private void ChangePage(string PageNumber,string Type, int? asc)
        {
            ...
            lstNewReq.DataSource = pageing.PageItems(20, int.Parse(PageNumber),
                helper.GetUnAssignedRequestsByUserName(Request.Cookies["UserName"].Value,
        ...
        {
            Response.Redirect("UnAssignedEmailApprovals.aspx");
        }
