                    ...
                    <div class="panel-body">
                            ...
                            <div style="top: 30px">
                                ...
                                <div class="form-group" id="RequestCreationTimeDiv" runat="server">
                                   ...
                                   Track Of Technical Approvel</button></div>
                                </div>
                                ...
                                <div class="form-group" id="UserNotesDiv" runat="server">
                                    <label class="col-sm-2 col-sm-2 control-label">Request Body  </label>
                                    <div class="col-sm-10">
                                       ...
                                       <%-- <div class="col-sm-3 " style="margin-left: 30%">
                                        ...
                                        <div class="col-sm-7" style="margin-left:38%">
                                         ...
                                         <br />
                                            ...
                                            <button type="submit" class="btn btn-primary" runat="server" onserverclick="EndTechnicalApprove" id="EndTechnicalApproveBtn">End Technical Approve</button>
                                        </div>
                                    </div>
                         ...
                         <p style="font-size:larger;">  Technical Approvel To Department</p> 
                            <textarea runat="server" name="txtImagename1" 
                               ...
                               <asp:ListBox ID="DepartmentList" runat="server" SelectionMode="Multiple"></asp:ListBox>
                                <asp:Button ID="TechnicalApproveFromDepartmentsBtn" CssClass="btn btn-danger"
