    ...
    public partial class OnlineApprovalManageRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          user =db.CallCenterAppUsers.Where(x=>x.UserName== userName).FirstOrDefault();
            ...
            UserMedicalID.Value = OnlineApprovalObj.Diagnose.ToString();
...
//var z = OnlineApprovalObj.OnlineApprovals_RequestAttachment.Where(x => x.RequestID == RequestID && x.RequestDetailsID == null);
    ...
    join r in db.OnlineApprovals_RequestDetailsTypeDIM on s.RequestDetailsTypeID equals r.RequestDetailsTypeID select 
   new { s.Delivered,s.DetailsDate,s.IsDeleted,s.Notes,s.RequestDetailsID,s.RequestDetailsTypeID,s.RequestID,s.Seen,s.UserID,s.UserTypeID,r.RequestDetailsTypeName};


            RequestDetails.DataSource = ListOfDetails;
