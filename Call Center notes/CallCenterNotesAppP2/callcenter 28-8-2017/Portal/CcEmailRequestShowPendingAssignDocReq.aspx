<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="CcEmailRequestShowPendingAssignDocReq.aspx.cs" Inherits="CallCenterNotesApp.Portal.CcEmailRequestShowPendingAssignDocReq" %>
    ...
    <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#"> Show Pending Assign Doctor Req </a></li>
                </ul>
            </div>
        </div>
</asp:Content>
                    ...
                    <div class="col-xs-12">
                        <div class="panel">
                            <header class="panel-heading">
                                Show Pending Assign Doctor Req
                            </header>
                            <br />
