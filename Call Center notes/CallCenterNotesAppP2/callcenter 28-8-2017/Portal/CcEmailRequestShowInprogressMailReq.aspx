<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CcEmailRequestShowInprogressMailReq.aspx.cs" Inherits="CallCenterNotesApp.Portal.CcEmailRequestShowAllInprogressMailReq" %>
    ...
    <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#"> Show Inprogress Sender Request </a></li>
                </ul>
            </div>
        </div>
</asp:Content>
                    ...
                    <div class="col-xs-12">
                        <div class="panel">
                            <header class="panel-heading">
                                Show Inprogress Sender Request
                            </header>
                            <br />
