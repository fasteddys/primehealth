<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ManageOpticalShop'sData.aspx.cs" Inherits="CallCenterNotesApp.Portal.ManageOpticalShop_sData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHeader" runat="server">
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    <li><a href="#"><i class="fa fa-home"></i>  Home</a></li>
                    <li><a href="#"> Manage Optical Data </a></li>
                </ul>
            </div>
        </div>
</asp:Content>
                                    ...
                                    <%--<div class="form-group" runat="server" id="TicketNumDiv"> 
                                        <div class="col-sm-12" align="Center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:DropDownList ID="OpticalSubLocationID" runat="server" class="form-control m-b-10" > </asp:DropDownList>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8" >
                                                    <textarea runat="server" id="OpticalNotesID" rows="3" class="form-control input-lg m-b-10"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <div class="col-sm-4">
                                                    <asp:DropDownList ID="OpticalCategoryID" runat="server" class="form-control m-b-10" >
...
<%--                                            <button type="submit" class="btn btn-primary" id="DeleteOpticalData" onserverclick="DeleteOpticalData_ServerClick" runat="server">Delet Optical Data </button>--%>
                                            <button type="submit" class="btn btn-primary" id="UpdateOpticalData" onserverclick="UpdateOpticalData_ServerClick" runat="server">Update Optical Data</button>
