...
namespace CallCenterNotesApp.MasterPages
{
    public partial class MasterPage : System.Web.UI.MasterPage
    {
        ...
        {
            var From = Request.Cookies["ReportDateFrom"].Value;
            var To = Request.Cookies["ReportDateTo"].Value;
           ...
           Request.Cookies["ReportDateFrom"].Value.Remove(0);
            Request.Cookies["ReportDateTo"].Value.Remove(0);
            ...
            {
                dtOperator.Rows.Add(item.OperatorAsignee, item.NumberOfTickets, item.AverageTicketTime);
            }
