...
namespace CallCenterNotesApp.BLL
{
    public class ClaimsApprovalClass
    {
        ...
        public string MobileAttchmentLocationPath()
        {
          string  SaveMobileAttachmentPath = db.EmailApprovalsConfigurations.Where(p => p.ConfigurationKey == "MobileImagesLocationPath").FirstOrDefault().ConfigurationValue.ToString();

            return SaveMobileAttachmentPath;
        }
        public string MobilePDFLocationPath()
        {
            string SaveMobileAttachmentPath = db.EmailApprovalsConfigurations.Where(p => p.ConfigurationKey == "MobilePDFLocationPath").FirstOrDefault().ConfigurationValue.ToString();

            return SaveMobileAttachmentPath;
        }
        public string MobilePDFLocationPathForClient()
        {
            string SaveMobileAttachmentPath = db.EmailApprovalsConfigurations.Where(p => p.ConfigurationKey == "MobilePDFLocationPathForClient").FirstOrDefault().ConfigurationValue.ToString();

            return SaveMobileAttachmentPath;
        }
        public string PublishedMobilePDFPath()
        {
            string SaveMobileAttachmentPath = db.EmailApprovalsConfigurations.Where(p => p.ConfigurationKey == "PublishedMobilePDFPath").FirstOrDefault().ConfigurationValue.ToString();
