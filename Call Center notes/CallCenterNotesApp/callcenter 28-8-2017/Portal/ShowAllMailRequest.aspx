<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ShowAllMailRequest.aspx.cs" Inherits="CallCenterNotesApp.Portal.ShowAllMailRequest" %>
...
<%--        <form runat="server">--%>
                ...
                <div class="col-xs-12">
                    <div class="panel">
                        ...
                        <div class="row" style="margin:5px">
                            <div class="col-md-2" style="padding-right:30px;padding-left:30px;" >
  ...
  <td>
                                                   <asp:CheckBox ID="CheckBox1" Checked='<%#Eval("IsFax") %>' runat="server" Enabled="false" />
