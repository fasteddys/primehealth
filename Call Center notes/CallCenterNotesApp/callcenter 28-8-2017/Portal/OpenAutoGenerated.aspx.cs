    ...
    public partial class OpenAutoGenerated : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
...

            {
                ...
                if (helper.CheckIsConflictRequest(Id) && request.DuplicatedTicketNumber==null)
                {
                    // class="modal fade in" tabindex="-1" aria-hidden="false" style="display:block !important;"

                    DuplicateDiv.Attributes["class"] = "modal fade in";
                    DuplicateDiv.Attributes["tabindex"] = "-1";
                    DuplicateDiv.Attributes["aria-hidden"] = "false";
                    DuplicateDiv.Attributes["style"] = "display:block !important;";
                }
        ...
        protected void Assignclick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (request.MailSource == "callcenter@prime-health.org")
                {
                    ...
                    UpdateEmailAsRead.AutoGeneratedEmailTrackingFlags(Id, false);
        ...
        protected void IgnoreBtn_ServerClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (request.MailSource == "callcenter@prime-health.org")
                {
                    ...
                    UpdateEmailAsRead.AutoGeneratedEmailTrackingFlags(Id, true);
        ...
        protected void btn_Submit_ServerClick(object sender, EventArgs e)
        {
            if (CallcenterOpenNote.Text != "")
            {
               ...
               && x.IsBCC == true).ToList();
                ...
                if (newpersonrecive.Count == 0)
                {
                    newpersonrecive = PersonreceiveEmail;
               ...
               MemberName.Value, ClientName.Value, Convert.ToInt32(MedicalID.Value), out ValidationResult,FaxNumber.Value,
               newpersonrecive
               );
        ...
        protected void ReplyBtn_ServerClick(object sender, EventArgs e)
        {
            if (OperatorNote.Text != string.Empty)
            {
               ...
               && x.IsBCC == true).ToList();
                ...
                string ValidationResult;
                bool valid = helper.ReplyOnInquiryByOperator(Id, OperatorNote.Text, Convert.ToInt32(RadioButtonList.SelectedValue), Request.Cookies["UserName"].Value.Trim(), FileUpload2.PostedFile, FileUpload2, out ValidationResult);
        ...
        protected void SaveAttached_ServerClick(object sender, EventArgs e)
        {
            if (FileUpload1.HasFile)
            {
                ...
                var isvalid = helper.EmailRequestFileUpload(FileUpload1.PostedFile, Id, Request.Cookies["UserType"].Value.Trim(), FileUpload1, false);
        ...
        protected void AddDuplicatedTicketNumber(object sender, EventArgs e)
        {
            string  message;
            if (helper.AddDuplicatedTicketNumber(Convert.ToInt32(Request.QueryString["Id"]), Convert.ToInt32(DuplicatedId.Value), Convert.ToInt32(Request.Cookies["UserID"].Value.Trim()), out message))
            {
                helper.IgnoreAndCloseEmailRequestUserName(Id, Request.Cookies["UserName"].Value.Trim(), out message);
                if (DuplicatedError.InnerText!="") {
                    DuplicatedError.Visible = true;
                    DuplicatedError.InnerText = message;
                }
            }
            Page.Response.Redirect(Page.Request.Url.ToString(), true);
