<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="DeleteHospitalBalack.aspx.cs" Inherits="CallCenterNotesApp.Portal.DeleteHospitalBalack" %>
...
&nbsp;<br />
     <div class="col-md-12" style="text-align: center;">
         <div class="toolbar-btn-action">
             ...
             <asp:Button ID="btn_delete_balack" class="btn btn-primary" runat="server" Text="Delete" Width="193px" OnClick="btn_delete_balack_Click" />
             <br />
             <br />
             <br />
          </div>
