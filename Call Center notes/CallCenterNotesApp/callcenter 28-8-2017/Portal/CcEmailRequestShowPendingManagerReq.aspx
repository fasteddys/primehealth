<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CcEmailRequestShowPendingManagerReq.aspx.cs" Inherits="CallCenterNotesApp.Portal.CcEmailRequestShowAllPendingManagerReq" %>
    ...
    <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#"> Show Pending Manager Request </a></li>
                </ul>
            </div>
        </div>
</asp:Content>
