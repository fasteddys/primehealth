<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="EditHospital.aspx.cs" Inherits="CallCenterNotesApp.Portal.EditHospital" %>
...
<%--                                        <form class="form-horizontal tasi-form" role="form" runat="server">--%>
                        ...
                        <label class="col-sm-2 col-sm-2 control-label">Select Hospital </label>
                           <div class="col-sm-4">
                               <asp:DropDownList ID="drop_hosptial" class="form-control input-lg m-b-10" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="HospName" DataValueField="ID" OnSelectedIndexChanged="drop_hosptial_SelectedIndexChanged"></asp:DropDownList>
                               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PhNetworkConnectionString %>" SelectCommand="SELECT [HospName], [ID] FROM [HospitalTB]"></asp:SqlDataSource>
                           </div>
                        </div>
                                            <div class="form-group">
                                            ...
                                            <div class="col-md-12" style="text-align:center;">
                                                <div class="toolbar-btn-action">
                                                    <asp:Button ID="btn_Edit_Hosptial" runat="server" class="btn btn-primary"  Text="Edit This Hospital" OnClick="btn_Edit_Hosptial_Click" />
