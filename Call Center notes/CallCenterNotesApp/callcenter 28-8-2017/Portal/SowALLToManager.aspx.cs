...
{
    public partial class SowALLToManager : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (id == 1)
            {
                ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("PendingOperator")).Attributes["class"] = "active";
            }
            if (id == 2)
            {
                ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("PendingDoctor")).Attributes["class"] = "active";
            }
            if (id == 3)
            {
                ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("PendingAudit")).Attributes["class"] = "active";
            }
            if (id == 4)
            {
                ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("AssignedOperator")).Attributes["class"] = "active";
            }
            if (id == 5)
            {
                ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("AssignedDoctors")).Attributes["class"] = "active";
            }
            if (id == 6)
            {
                ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("AssignedAudit")).Attributes["class"] = "active";
            }
            if (!IsPostBack)
        ...
        public void Bind(string Type,string SubType, int? asc)
        {
            try
            {
                ...
                var data = helper.GetTicketForDirectorUser(user, Type, SubType, asc,id).Take(20).ToList();
                ...
                int NumberOfPages = pageing.PageNumbers(20, helper.GetTicketForDirectorUser(user, Type, SubType, asc,id).Count());
        ...
        private void ChangePage(string PageNumber)
        {
            ...
            lstNewReq.DataSource = pageing.PageItems(20, int.Parse(PageNumber),
                helper.GetTicketForDirectorUser(Request.Cookies["UserName"].Value, 
                DropDownType.SelectedValue,DropDownSubType.SelectedValue 
                ,Convert.ToInt16(DropDownAsc.SelectedValue),id));
            lstNewReq.DataBind();
