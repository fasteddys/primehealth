    ...
    public partial class ManageClaimsApprove : System.Web.UI.Page
    {
        ...
        protected void DownloadClientImage(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.TransmitFile(mdb.MobileAttchmentLocationPath() + UserImagepathstr + ".jpg");
                Response.Flush();
        ...
        protected void DownloadClientImage2(object sender, EventArgs e)
        {
            try
            {
                ...
                //Response.TransmitFile(Server.MapPath(UserImagepathstr));
                Response.TransmitFile(mdb.MobileAttchmentLocationPath()+ UserImage2pathstr + ".jpg");
                Response.Flush();
            }
            catch (Exception ex)
            {
        ...
        protected void DownloadClientImage3(object sender, EventArgs e)
        {
            try
            {
                ...
                //Response.TransmitFile(Server.MapPath(UserImagepathstr));
                Response.TransmitFile(mdb.MobileAttchmentLocationPath() + UserImage3pathstr + ".jpg");
                Response.Flush();
            }
            catch (Exception ex)
            {
        ...
        protected void DownloadClientImage4(object sender, EventArgs e)
        {
            try
            {
                ...
                //Response.TransmitFile(Server.MapPath(UserImagepathstr));
                Response.TransmitFile(mdb.MobileAttchmentLocationPath()  + UserImage4pathstr + ".jpg");
                Response.Flush();
            }
            catch (Exception ex)
            {
        ...
        protected void DownloadClientImage5(object sender, EventArgs e)
        {
            try
            {
                ...
                //Response.TransmitFile(Server.MapPath(UserImagepathstr));
                Response.TransmitFile(@mdb.MobileAttchmentLocationPath() + UserImage5pathstr + ".jpg");
                Response.Flush();
            }
            catch (Exception ex)
            {
        ...
        protected void DownloadCallCenterImage(object sender, EventArgs e)
        {
            try
            {
             ...
             //var z=   Server.MapPath(@"\\PDFReply\\") + id.ToString() + @"\\" + CallCenterImageRealPath;
                ...
                Response.TransmitFile(mdb.MobilePDFLocationPath() + id.ToString()+@"\"+ CallCenterImageRealPath);
                Response.Flush();
        }
            catch (Exception ex)
            {
        ...
        public bool UploadFile()
        {
                ...
                if (CallCenterComment.Value != "")
            {
                ...
                Random RandomApprovalNum = new Random();
                    ...
                    string UploadUserPDF = mdb.MobilePDFLocationPathForClient()+ FileName + ".pdf";

                    base64String = mdb.PublishedMobilePDFPath() + FileName + ".pdf";
                  ...
                  if( ! File.Exists(UploadUserPDF))
                    ...
                    Directory.CreateDirectory(mdb.MobilePDFLocationPath() + id + " /");
                    FileUpload1.SaveAs(mdb.MobilePDFLocationPath() + id + " /" + FileName + ".pdf");
