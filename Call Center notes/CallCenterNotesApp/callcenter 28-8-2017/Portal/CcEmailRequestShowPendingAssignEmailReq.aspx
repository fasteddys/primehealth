<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CcEmailRequestShowPendingAssignEmailReq.aspx.cs" Inherits="CallCenterNotesApp.Portal.CcEmailRequestShowPendingAssignEmailReq" %>
    ...
    <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#"> SShow Pending Assign Sender Req </a></li>
                </ul>
            </div>
        </div>
</asp:Content>
                    ...
                    <div class="col-xs-12">
                        <div class="panel">
                            <header class="panel-heading">
                                Show Pending Assign Sender Req
                            </header>
                            <br />
