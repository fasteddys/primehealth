<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="UnAssignedEmailApprovals.aspx.cs" Inherits="CallCenterNotesApp.Portal.UnAssignedEmailApprovals" %>
...
<%--                                    <th style='text-align: center;'>Close Time</th>--%>
                                    ...
                                    <th style='text-align: center;'>Is Fax</th>
...
<%--                                            <td><strong><%#Eval("ClosedTime") %></strong></td>--%>
  ...
  <td><asp:CheckBox ID="CheckBox1" Checked='<%#Eval("IsFax") %>' Enabled="false" runat="server" />
            ...
            <asp:Panel ID="Panel2" runat="server">
               ...
               <asp:ScriptManager ID="ScriptManager1" runat="server" />
                                <asp:Timer ID="Timer1" OnTick="RefreshPageTimerFN" runat="server" Interval="60000" />
<%--</form>--%>
