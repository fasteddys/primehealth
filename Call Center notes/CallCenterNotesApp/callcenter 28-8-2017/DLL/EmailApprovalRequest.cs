...
namespace CallCenterNotesApp.DLL
{
    ...
    public partial class EmailApprovalRequest
    {
        ...
        public EmailApprovalRequest()
        {
            ...
            this.EmailApprovalReceivingReceipts = new HashSet<EmailApprovalReceivingReceipt>();
        ...
        public Nullable<int> DuplicatedTicketNumber { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<EmailApprovalReceivingReceipt> EmailApprovalReceivingReceipts { get; set; }
