<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="ManageRemb.aspx.cs" Inherits="WebApplication1.Portal.ManageRemb" %>
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                <ul class="breadcrumb">
                    ...
                    <li>
                        Remb<a href="ManageRemb.aspx">Admin</a>
                    </li>
                    <li>
                            ...
                            <ItemTemplate>
                                <tr>
                                             <td><strong><%#Eval("BatchID")%></strong></td>
                                               ...
                                               <td><strong><%#Eval("Comment")%></strong></td>
                   ...
                   <tbody>
                            ...
                            <EditItemTemplate>
                                <tr align="center">
                                    ...
                                    <td>
                                        <asp:TextBox ID="CMMTXT" runat="server" Text=' <%#Eval("Comment")%>' />
                                    </td>
                                       <td>
                                        <asp:TextBox ID="TextBox1" runat="server" Text=' <%#Eval("AddedBy")%>' />
                                    </td>
                                     <td>
                                        <asp:TextBox ID="TextBox2" runat="server" Text=' <%#Eval("AddTime")%>' />
                                    </td>
                                    <td>
                                        <div class="btn-group btn-group-xs">
