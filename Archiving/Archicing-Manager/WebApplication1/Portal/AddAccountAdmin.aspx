<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="AddAccountAdmin.aspx.cs" Inherits="WebApplication1.Portal.AddAccountAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <div class="jumbotron" data-pages="parallax">
    ...
    <div class="container-fluid container-fixed-lg" id="id2" runat="server">
        <div class="row">
            <div class="col-md-12">
                        ...
                        <form class="" id="myForm" role="form">
                            ...
                            <div class="form-group form-group-default required ">
                                ...
                                <asp:DropDownList runat="server" ID="TypeDLL" class="form-control required" required="required">
                                    ...
                                    <asp:ListItem>EnterpriseAdmin</asp:ListItem>
                                    <asp:ListItem>Archiving</asp:ListItem>
                                    <asp:ListItem>ArcAdmin</asp:ListItem>
                                    <asp:ListItem>User</asp:ListItem>
                                    <asp:ListItem>Remb</asp:ListItem>
                                    <asp:ListItem>Data Entry</asp:ListItem>
                                    <asp:ListItem>TPA</asp:ListItem>
                                    <asp:ListItem>TPAAdmin</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="This Filed Is Required" ControlToValidate="Emailtxt" ForeColor="Red"></asp:RequiredFieldValidator>
                            <div class="form-group form-group-default required ">
                                <label>Email</label>
                                <input type="text" runat="server" id="Emailtxt" class="form-control required" required="required">
                            </div>
