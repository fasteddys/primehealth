...
{
    public partial class ManageUsersadmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (type == "EnterpriseAdmin")
            {
                ...
                ((System.Web.UI.HtmlControls.HtmlGenericControl)Page.Master.FindControl("Span9")).Attributes["class"] = "icon-thumbnail bg-success";
                if (!IsPostBack)
                {
                    Bind();
                }
        ...
        public void Bind()
        {
            var data = ac.GetDataForEnterprise();
