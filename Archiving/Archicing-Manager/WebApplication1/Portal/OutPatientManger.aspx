<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="OutPatientManger.aspx.cs" Inherits="WebApplication1.Portal.OutPatientManger" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                <ul class="breadcrumb">
                    ...
                    <li>
                        OUT Patient<a href="OutPatientManger.aspx">Admin</a>
                    </li>
                    <li>
   ...
   <br />
    <div class="container-fluid container-fixed-lg bg-white">
     ...
     <asp:ListItem>Claim Code</asp:ListItem>
                   ...
                   <tbody>
                            ...
                            <EditItemTemplate>
                                <tr align="center">
                                    ...
                                    <td>
                                        <asp:TextBox ID="ClaimNumtxt" runat="server" Text=' <%#Eval("ClaimCode")%>' />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:TextBox ID="numclaimtxt" runat="server" Text=' <%#Eval("NumOfClaims")%>' />
                                    </td>
                                    <td><b><%#Eval("AddedBy") %></b></td>
                                    <td><%#Eval("AddTime") %></td>
                                                                        <td>
