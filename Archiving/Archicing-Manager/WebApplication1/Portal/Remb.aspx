<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Remb.aspx.cs" Inherits="WebApplication1.Portal.Remb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron" data-pages="parallax">
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">New Remb Transaction</a>
                    </li>
                </ul>
        ...
        <div class="row" id="addremb" runat="server">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">
                            Add New Remb Transaction</div>
                    </div>
                    <div class="panel-body">
                        <form class="" id="myForm" role="form" onSubmit="return validateComplete(document.myform)">
                            ...
                            <div class="form-group form-group-default required ">
                                <label>Comment</label>
                                <input type="text" runat="server" id="Text3" class="form-control required" required="required">
                            </div>
