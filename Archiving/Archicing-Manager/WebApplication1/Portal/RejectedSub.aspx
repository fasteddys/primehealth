<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="RejectedSub.aspx.cs" Inherits="WebApplication1.Portal.RejectedSub" %>
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Rejected Submission Requests</a>
                    </li>
                </ul>
            </div>
        </div>
