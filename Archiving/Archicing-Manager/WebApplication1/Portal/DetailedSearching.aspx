<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="DetailedSearching.aspx.cs" Inherits="WebApplication1.Portal.DetailedSearching" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20" >
            <div class="inner">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#" class="active">Search Tickets</a>
                    </li>
                </ul>
            </div>
        </div>
   ...
   <br />
    <div class="container-fluid container-fixed-lg bg-white">
     ...
     <asp:ListItem>Attachment Name</asp:ListItem>
    </asp:DropDownList>
      <br /> 
      <br />
           <div>
